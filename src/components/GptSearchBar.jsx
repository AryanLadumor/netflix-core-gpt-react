...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    const response = await ai.models.generateContent({
      // Use the 3.1 Flash-Lite model for maximum speed
      ...
      generationConfig: {
        maxOutputTokens: 10, // Limits processing time
        temperature: 0.001, // Lower temperature = faster, more predictable results
      },
    });
